...
\subsubsection{nf\_conntrack\_tuple}
...
\subsubsection{nf\_conntrack\_tuple\_hash}
...
Global conntrack entities in network namespace. Tracks global entities like pointer to the expect\_hash hash table for expected packets.
